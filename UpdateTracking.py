...
# SERIES = [{
#     'company_id': 337, 'shipped_method': 'DHL SmartMail Parcel Expedited', 'days_ago': 0,
#     'start_date': '2019-10-01', 'end_date': '2019-11-01'
# }]
# SERIES = [{
#     'company_id': 1560, 'shipped_method': 'DHL SmartMail Parcel Expedited', 'days_ago': 0,
#     'start_date': '2019-10-01', 'end_date': '2020-03-01', 'batch': True
# }]
...
def main():
    ...
    for i, set in enumerate(SERIES):
        ...
        mainLoop(i + 1, len(SERIES), set['batch'])
    ...
    query = """
        SELECT ps.PackageShipmentID, ps.TrackingNumber
            ...
            WHERE ps.CompanyID = %s
                ...
                {}
    """
    # AND Country IN('China', 'Hong Kong')
